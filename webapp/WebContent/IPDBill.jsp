...
%>
		<form name="bookappointmentform" action="GenrateIPDBill" method="post">
        ...
        <div class="advanceSearch" style="width:100%;margin:0;border-radius:0;">
    		...
    		<table cellspacing="5" cellpadding="10" class="book_appointment_table">
                <tr>
					...
					<td><input type="text" name="dateOfDischarge" id="combined-picker4" readonly="readonly" value="${param.dischargedate }"/></td>                      	
                 </tr>
                 <tr>
                 	<td>Suregry Description:</td>
                 	<td colspan="2"><textarea cols="37" rows="3" name="suregryDescription"></textarea></td>
                 	<td>Final Diagnosis</td>
                    <td colspan="2"><textarea cols="37" rows="3" name="finalDiagnosis"></textarea></td>    
                 </tr>
                 <tr>
                 	<td>Anaesthetist Doctor: </td>
                 	<td><input type="text" name="anaesthetistDoctor" value="${param.anaesthetistDoctor }"/></td>
                ...
                <tr>                        
                	...
                	<tr>
                        ...
                        <td>Cause Of Death: </td>
                     	<td><input type="text" name="patient_cause_of_death"  /></td>  
                     	<td>Death Certificate No.: </td>
                       	<td><input type="text" name="patient_death_certificateNo" /></td>                      	
                   </tr>
                    <tr>                        
    	...
    	<div class="advanceSearch" style="width:100%;margin:0;border-radius:0;">
    		...
    		<table cellspacing="5" cellpadding="10" class="book_appointment_table" id="billingTable">
    			<tr>
    				...
    				<td><input type="text" name="ipdregistrationcharges" id="ipdregistrationcharges" onkeyup="calculateTotal();" value="0" required/></td>    				
    			</tr>
    			<tr>
    				<td>Room Type: </td>
    				<td>
    				...
    				<td>Room/Bed No</td><td><input type="text" name="roomOrBedNo"  /></td>
    			</tr>
    			<tr>
    				<td>Room Charges: </td><td><input type="text" name="roomCharges" id="roomCharges" onkeyup="calculateTotal();" value="0" autocomplete="off"/></td>
    				<td>@ Rs. :</td><td><input type="text" name="perRoomCharge" id="perRoomCharge" value="0" style="width:50%;margin-right:0.2em"autocomplete="off"/>per day</td>
    			</tr>
    			<tr>
    				<td>Nursing Charges :</td><td><input type="text" name="nursingCharges"  id="nursingCharges" onkeyup="calculateTotal();" value="0" autocomplete="off" /></td>
    				<td>@ Rs. :</td><td><input type="text" name="perNursingCharges" value="0" style="width:50%;margin-right:0.2em" autocomplete="off"/>per day<td>
    			</tr>
    			<tr>
    				...
    				<td>
    					...
    					<input type="text" name="v1charges" id="v1charges" style="width:30%;" onkeyup="calculateTotal();" value="0"/>
    				</td>
    				<td>
    					...
    					<input type="text" name="v2charges" id="v2charges" style="width:25%;" onkeyup="calculateTotal();" value="0" autocomplete="off"/>
    				</td>
    				<td>
    					...
    					<input type="text" name="v3charges" id="v3charges"  style="width:30%;" onkeyup="calculateTotal();" value="0" autocomplete="off"/>
    				</td>
    			</tr>
    			<tr>
    				<td>Operating Charges: </td><td><input type="text" name="operatingCharges" id="operatingCharges" onkeyup="calculateTotal();" value="0" autocomplete="off"/></td>
    				<td>Assistant's Charges: </td><td><input type="text" name="assistantsCharges" id="assistantsCharges" onkeyup="calculateTotal();" value="0" autocomplete="off"/></td>
    			</tr>
    			<tr>
    				<td>Operation theater charges: </td><td><input type="text" name="otCharges" id="otCharges" onkeyup="calculateTotal();" value="0" autocomplete="off"/></td>
    				<td>Oxygen Charges: </td><td><input type="text" name="oxygenCharges" id="oxygenCharges" onkeyup="calculateTotal();" value="0" autocomplete="off"/></td>
    			</tr>
    			<tr>
    				<td>Anaesthesia Drugs,O.T. Drugs, Suture, Material etc. Charges: </td><td><input type="text" name="otherCharges" id="otherCharges" onkeyup="calculateTotal();" value="0" autocomplete="off"/></td>
    				<td>Anaesthesia Charges Doctor: </td><td><input type="text" name="anaesthesiaDoctorCharges" id="anaesthesiaDoctorCharges" onkeyup="calculateTotal();" value="0" autocomplete="off"/></td>
    			</tr>
    			<tr>
    				<td>Special Instruments/Equipments CHarges</td><td><input type="text" name="specialInstrumentCharges" id="specialInstrumentCharges" onkeyup="calculateTotal();" value="0" autocomplete="off"/></td>
    				<td>Implants and/Or Other Materials Chrages: </td><td><input type="text" name="implantsOtherMaterialCharges" id="implantsOtherMaterialCharges" onkeyup="calculateTotal();" value="0" autocomplete="off"/></td>
    			</tr>
    			<tr>
    				<td>Delivery Charges: </td><td><input type="text" name="deliveryCharges" id="deliveryCharges" onkeyup="calculateTotal();" value="0" autocomplete="off"/></td>
    				<td>Labour Room Charges: </td><td><input type="text" name="labourRoomChrges" id="labourRoomChrges" onkeyup="calculateTotal();" value="0" autocomplete="off"/></td>
    			</tr>
    			<tr>
    				<td>Baby Care Charges: </td><td><input type="text" name="babyCareCharges" id="babyCareCharges" onkeyup="calculateTotal();" value="0" autocomplete="off"/></td>
    				<td>I.V fusions and/or Blood Transfusions: </td><td><input type="text" name="ivOrBloodTransfusionsCharges" id="ivOrBloodTransfusionsCharges" onkeyup="calculateTotal();" value="0" autocomplete="off"/></td>
    			</tr>
    			<tr>
    				<td>Disposable Material:</td><td><input type="text" name="disposableMaterial" id="disposableMaterial" onkeyup="calculateTotal();" value="0" autocomplete="off"/></td>
    				<td>Hospital's Drugs, Medicines, etc. and/or Drug Administration charges: </td><td><input type="text" name="hospitalAdministrationCharges" id="hospitalAdministrationCharges" onkeyup="calculateTotal();" value="0" autocomplete="off"/></td>
    			</tr>
    			<tr>
    				<td>Dressing/or Plaster Charges: </td><td><input type="text" name="dressingOrPlasterCharges" id="dressingOrPlasterCharges" onkeyup="calculateTotal();" value="0" autocomplete="off"/></td>
    				<td>Laboratory Chrages: </td><td><input type="text" name="labCharges" id="labCharges" onkeyup="calculateTotal();" value="0" autocomplete="off"/></td>
    			</tr>
    			<tr>
    				<td>Special investigation Charges: </td><td><input type="text" name="investigationCharges" id="investigationCharges" onkeyup="calculateTotal();" value="0" autocomplete="off"/></td>
    			</tr>
    			<tr>
    				<td >X-Ray Charges: </td>
    				<td colspan="3">Per Price<input type="text" name="perPricexray" id="perPricexray" onkeyup="calculatexraycharges();"/>Qty.<input type="text" name="xrayqty" id="xraqty" onkeyup="calculatexraycharges();" value="0" autocomplete="off"/>
    			...
    			<tr>
    				<td>Concession: </td><td><input type="text" name="concession" id="concession" onkeyup="calculateTotal();" value="0"  /></td>
    			...
    			<tr>
    				...
    				<td>Amount paid: </td><td><input type="text" name="amountPaid" id="amountPaid" onkeyup="calculateTotal();" value="0" /></td>
    			</tr>
    			<tr>
    				<td>Balance</td><td><input type="text" name="balance" id="balance" onkeyup="calculateTotal();" value="0" readonly="readonly"/></td>
    				<td>MLC No. :</td><td><input type="text" name="mlcno" value="<%= mlcno %>"/>
    					<input type="hidden" name="roomtypetext" id="roomtypetext" />
    				</td>
    			</tr>
    			<tr>
                        <td colspan="2"><input type="submit" value="GENERATE BILL" style="font-family: Candara;margin: 0 1em 0 40em;color: #FFFFFF;background-color: #337ab7;padding: 0.2em 1.4em 0.3em;border-radius: 3px;border: 1px solid #337ab7;"/></td>
                   </tr>
    		</table>
    	</div>
    	<!-- /Billing Details -->
