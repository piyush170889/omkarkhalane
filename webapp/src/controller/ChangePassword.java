...
public class ChangePassword extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String userpass = request.getParameter("OldPassword").trim();
			...
			if(rs.next()){
				...
				out.println("<script type=\"text/javascript\">alert('Wrong username or Password')</script>");
				utilities.CommonUtilities.returnToChangePassword(response);
			}
		}catch(Exception e){
			try {
				con.rollback();
