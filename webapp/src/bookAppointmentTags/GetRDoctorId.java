...
public class GetRDoctorId extends TagSupport {
	...
	public int doStartTag() throws JspException {
		...
		String maxBookId;
		try{			
			PreparedStatement pst0 = con.prepareStatement("select count(*) from omk_refernce_doctor");
			ResultSet rs0 = pst0.executeQuery();
			rs0.next();
			if(rs0.getInt(1) == 0){
				out.println("RD1");
			}else{
				PreparedStatement pst = con.prepareStatement("select max(srno) from omk_refernce_doctor");
