...
public class OPDAttendedCount extends TagSupport {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3868580070025250428L;
	...
	public int doStartTag() throws JspException {
		...
		try{
			...
			String currDate = sdf.format(new Date()).toString();
